#include "StdAfx.h"
#include "../StdAfx.h"
#include "CLavaGolemAIState.h"
#include "../Game Objects/CPlayer.h"

// Singleton's instance
CLavaGolemAIState* CLavaGolemAIState::sm_pInstance = NULL;

IBaseAIState* CLavaGolemAIState::GetInstance(void)
{
	if(!sm_pInstance)
		sm_pInstance = new CLavaGolemAIState();
	return sm_pInstance;
}

void CLavaGolemAIState::DeleteInstance(void)
{
...
void CLavaGolemAIState::Enter(CBaseCharacter* pCharacter)
{
	...
	pCharacter->SetBehavior(CBaseCharacter::BEHAVIOR_LAVAGOLEM);
...
void CLavaGolemAIState::Update(CBaseCharacter* pCharacter, float fElapsedTime)
{
...
void CLavaGolemAIState::Exit(CBaseCharacter* pCharacter)
{
