...
namespace BodagheeParticleTool
{
    public partial class Form1 : Form
    {
        ...
        public void Render()
        {
            ...
            {
                SGP.ManagedTextureManager.Instance.Draw(BackGroundImageID, 0, 0, 1.0f, 1.0f, Rectangle.Empty, 0, 0, 0.0f, Color.White.ToArgb());
            } 
        ...
        private void LoadBackGroundImage_Click(object sender, EventArgs e)
        {
            ...
            if (DialogResult.OK == ofd.ShowDialog())
            {
                BackGroundImage = ofd.FileName;
            }
            BackGroundImageID = TM.LoadTexture(BackGroundImage, Color.Black.ToArgb());
        }
    }
}
