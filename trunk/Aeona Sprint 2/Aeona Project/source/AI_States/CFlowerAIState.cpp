#include "StdAfx.h"
#include "../StdAfx.h"
#include "CFlowerAIState.h"
#include "../Game Objects/CPlayer.h"

// Singleton's instance
CFlowerAIState* CFlowerAIState::sm_pInstance = NULL;

IBaseAIState* CFlowerAIState::GetInstance(void)
{
	if(!sm_pInstance)
		sm_pInstance = new CFlowerAIState();
	return sm_pInstance;
}

void CFlowerAIState::DeleteInstance(void)
{
...
void CFlowerAIState::Enter(CBaseCharacter* pCharacter)
{
	...
	pCharacter->SetBehavior(CBaseCharacter::BEHAVIOR_FLOWER);
...
void CFlowerAIState::Update(CBaseCharacter* pCharacter, float fElapsedTime)
{
...
void CFlowerAIState::Exit(CBaseCharacter* pCharacter)
{
