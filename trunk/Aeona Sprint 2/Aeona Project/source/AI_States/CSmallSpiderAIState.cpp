#include "StdAfx.h"
#include "../StdAfx.h"
#include "CSmallSpiderAIState.h"
#include "../Game Objects/CPlayer.h"

// Singleton's instance
CSmallSpiderAIState* CSmallSpiderAIState::sm_pInstance = NULL;

IBaseAIState* CSmallSpiderAIState::GetInstance(void)
{
	if(!sm_pInstance)
		sm_pInstance = new CSmallSpiderAIState();
	return sm_pInstance;
}

void CSmallSpiderAIState::DeleteInstance(void)
{
...
void CSmallSpiderAIState::Enter(CBaseCharacter* pCharacter)
{
...
void CSmallSpiderAIState::Update(CBaseCharacter* pCharacter, float fElapsedTime)
{
...
void CSmallSpiderAIState::Exit(CBaseCharacter* pCharacter)
{
