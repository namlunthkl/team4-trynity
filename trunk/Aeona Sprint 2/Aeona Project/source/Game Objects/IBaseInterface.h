...
{
public:
	enum Type { TYPE_OBJ_BASE, TYPE_CHAR_BASE, TYPE_CHAR_PLAYER, TYPE_CHAR_ENEMY,TYPE_CHAR_FINALBOSS, TYPE_CHAR_NPC, TYPE_CHAR_CHEST,
				TYPE_WEAPON_DAGGER, TYPE_WEAPON_SWORD, TYPE_WEAPON_HAMMER, TYPE_WEAPON_ARROW, TYPE_WEAPON_CROSSBOW, TYPE_WEAPON_BOULDER,TYPE_WEAPON_FIREBALL,TYPE_WEAPON_TORNADO, TYPE_MAX };
